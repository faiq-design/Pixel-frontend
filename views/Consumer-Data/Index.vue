      ...
      <div class="col-xl-12">
        <div class="card">
          <div class="card-header justify--flex-end">
            <div class="dropdown" v-click-outside="clickOutSideFilter">
              <button
                type="submit"
                class="btn btn--secondary__teal"
              ...
              <div
                ...
                <div class="form-field form-field__outline ma-1">
                  <div class="form-field__outline--control">
                    ...
                    <label
                      for="city"
                      class="form-field__outline--control__label">City</label>
                  </div>
                </div>
                ...
                <div class="form-field form-field__outline ma-1">
                  <div class="form-field__outline--control">
                    ...
                    <label
                      for="state"
                      class="form-field__outline--control__label">State</label>
                  </div>
                </div>
                ...
                <div class="form-field form-field__outline ma-1">
                  <div class="form-field__outline--control">
                    ...
                    <label
                      for="zipcode"
                      class="form-field__outline--control__label">Zipcode</label>
                  </div>
                </div>

...
export default class PurchaseLeads extends Vue {
  ...
  public checkifSubmitDisabled()
  {
    return this.insufficentCredits;
  }
  ...
  public checkCredits() {
    if (this.credits >= this.response)
    {
      this.insufficentCredits = false;
    }
  ...
  public getCreditsFromSite() {
    this.sitesService
        .getCredits(parseInt(this.siteId))
